    ...
    <main className="about-body">
      <div className="aboutUs-container">
        ...
        <p><span className="subtitle">What happens to your Cryptocurrencies when you die?</span><br />
          ...
          <span className="uk-text-bold subtitle">How do we ensure this you ask?, it's simple.</span><br />
            ...
            fire or a flood
            <br /><br />
          <span className="uk-text-bold subtitle">How do I get my crypto sent to my backup address if/when I lose access?</span><br />
            ...
            <br /><br />
          <span className="uk-text-bold subtitle">How do I get started?</span><br />
            We advise you use SafeKeep with Google Chrome browser and also download the MetaMask extension
            <a href="https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn?hl=en" target="_blank" rel="noopener">here</a> and set it up (We'll add support for other wallets soon)<br /> <br />
            Once that is done, Click on the Connect button on the Navbar or homepage to connect your MetaMask wallet to SafeKeep Dapp<br /> <br /> 
            You should see a balance of 0 Eth if this is your first time; All you have to do now is click on the Withdraw button to open the Withdraw Modal<br /> <br />
